...
We have 3 models. <br/>
First is with all factors, 3 congenial and 3 acquired influncing factors. <br>
...
The last model focus only on congenial factors, which is nested in the first model.
...
All congenial factors matters, while only high caloric food consumption and its interation with alcohol consumption lead to overweight conditions.
...
In the plot showing RMSE, we see the model 1 and model 2 are with the smallest RMSE, showing that those two models fit well. For the third model only focus on congenial factors, it confirms the inference in the coefficients table that **_acquired factors also matter_**.
